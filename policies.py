...
aramar = ['body', 'eyes', 'hair', 'mask', 'name', 'scar', 'files', 'image', 'mouth', 'glasses', 'weapons', 'clothing', 'earrings', 'nosering', 'companion', 'mediaType', 'background', 'facial_hair', 'hoskinanium']
atsuko = ['Body', 'Face', 'Hair', 'Mask', 'Name', 'name', 'files', 'image', 'Tattoo', 'Weapon', 'Clothing', 'Companion', 'Underlord', 'Urshanabi', 'mediaType', 'Background', 'Hoskinanium', 'Spirit_Guardian']
list_policy_id = [policy_id_aramar, policy_id_atsuko, policy_id_daisuke, policy_id_fourth]
list_policy_id_test = [policy_id_small, policy_id_small1]
list_policy_id_one = [policy_id_aramar]
...
policy_ids = {  '83c0ab67afc9148bd1571b7a14de1df03cd5624f5992d3b8ec84d6fb' : 'Aramar'  ,
